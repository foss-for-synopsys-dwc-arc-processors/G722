# -----------------------------------------------------------------------------
#	Borland tcc makefile for compiling and testing the UGST MNRU 
#       implementation
...
mnrudemo: mnrudemo.obj mnru.obj ugst-utl.obj
	$(CC) $(CC_OPT) -emnrudemo mnrudemo.obj mnru.obj ugst-utl.obj 
