/*                                                            22.SEP.1994 v1.0
  ...
  IIR G.712 filtering without rate conversion using the IIR-G.712 module.

  Usage:
  ~~~~~~
  $ IIRDEMO ! ---> HELP text is printed to screen
  or
  $ IIRDEMO [-options] ifile ofile [lseg]
  where:
  ...
  $ CC IIRDEMO
  $ link IIRDEMO
  $ IIRDEMO :== $iirdemo_Disk:[iirdemo_Dir]IIRDEMO
  $ IIRDEMO ifile ofile 0 1_2 2_1 133
  ...
  2) the G.712 filtering just keep the input data as is;
  ...
  Turbo-C, Turbo-C++:
  > tcc iirdemo
  > iirdemo ifile ofile 1_1 1_1 2_1 1024
  ...
  > hc386 -stack 16384 iirdemo.c
  > Run386 iirdemo ifile ofile 2_1 1_2 0 133
...
void display_usage()
{
  P(("C712DEMO.C - Version 1.0 of 30/Oct/1994 \n\n"));
